        ...
        const app = Vue.createApp({
            ...
            methods: {
                ...
                searchPlaces() {
                    ...
                    ps.categorySearch(self.currCategory, placesSearchCB, { useMapBounds: true });
                },
            ...
            mounted() {
                ...
                // 지도를 생성합니다    
                var map = new kakao.maps.Map(self.mapContainer, self.mapOption);
