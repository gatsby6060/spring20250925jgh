    ...
    <script>
        const app = Vue.createApp({
            ...
            methods: {
                ...
                fnAdd2: function () { //2번쨰 만드는거라 2 붙임
                    let self = this;
                    let param = {
                    ...
                    // alert("서버 보내기 직전2");
                    $.ajax({
                        url: "/product/add2.dox",
                        dataType: "json",
                        type: "POST",
                        data: param,
                        success: function (data) {
                            if (data.result == "success") {
                                // alert("음식 등록하고 돌아온 data값 (등록되었습니다) " + JSON.stringify(data));
                                console.log(data);
                                ...
                                alert("입력 되었습니다.");
                                location.href = "/product.do"; //잠시 수석처리
                            } else {
                                alert("오류가 발생했습니다.");
                            }
